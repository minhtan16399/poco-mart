                        ...
                        <div className={'flex flex-col gap-4'}>
                            ...
                            <div className={'flex flex-col gap-2'}>
                                ...
                                <div className={'flex items-center gap-1'}>
                                    {product.price.map((item, index) => (
                                        <button className={selectedVersion === item.version ? 'border border-red-600 rounded-md p-2' : 'border border-neutral-300 hover:border-red-600 rounded-md p-2'}
                            ...
                            <div className={'flex flex-col gap-2'}>
                                ...
                                <div className={'flex items-center gap-1'}>
                                    {product.image.map((item, index)=> (
                                        <button className={selectedColor === index ? 'w-10 border border-red-600 rounded-md p-1' : 'w-10 border border-neutral-300 hover:border-red-600 rounded-md p-1'}
                            ...
                            <div className={'py-2'}>
                                <div className={'flex items-center border border-neutral-300 w-fit'}>
                                    <button className={'text-red-600 hover:bg-red-600 h-full hover:text-white text-xl py-1.5 px-4'} onClick={()=>setCountHandler('minus')}>-</button>
                                    <span className={'border-x border-neutral-300 p-1 w-20 text-center text-2xl font-bold'}>{count}</span>
                                    <button className={'text-red-600 hover:bg-red-600 hover:text-white text-xl py-1.5 px-4'} onClick={()=>setCountHandler('plus')}>+</button>
                                </div>
                            </div>
                            <div>
                                <div className={'gap-5 grid grid-cols-8'}>
                                    <button className={'text-nowrap col-span-3 font-medium flex flex-col justify-center items-center border text-white bg-red-500 p-3 rounded-md hover:bg-white hover:text-red-600 border-red-500'}>
                                        <span className={'uppercase'}>Thêm vào giỏ</span><span>Cam kết chính hãng / đổi trả 24h</span>
                                    </button>
                                    <button className={'col-span-2 font-medium text-nowrap flex flex-col justify-center items-center border text-white bg-[#0fa80f] p-3 rounded-md hover:bg-white hover:border-yellow-500 hover:text-yellow-500 border-[#0fa80f]'}>
